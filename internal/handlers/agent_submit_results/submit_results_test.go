...
func makeResult(agentID uuid.UUID, checkType api.CheckType, address string) api.MonitoringResult {
return api.MonitoringResult{
Id:        uuid.Must(uuid.NewV7()),
AgentId:   agentID,
CheckType: checkType,
Target:    api.Endpoint{Address: address, Tags: []string{}},
...
avg := 15.0
result := makeResult(wrongAgentID, makePingCheck(t, "1.2.3.4", 3, 0, &avg), "8.8.8.8")
...
i := 7
if ptrIntVal(&i) != 7 {
t.Error("ptrIntVal mismatch")
}
if ptrIntVal(nil) != 0 {
t.Error("ptrIntVal(nil) should be 0")
}
