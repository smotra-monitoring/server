...
- [ ] resolved_ip renamed to address in traceroute_hops table. We should standardize on one naming convention for this field across all tables to avoid confusion.
